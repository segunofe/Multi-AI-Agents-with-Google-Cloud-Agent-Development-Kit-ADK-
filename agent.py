...
# Define the Pydantic model         # this 
...
async def main():
    ...
    # 3. Define Your Agent with the Schema and Transfer Restrictions
    root_agent = Agent(
        model=model_name,
        name="geo_validator",
        ...
        # Enforce structured standards
        output_schema=CountryCapital,     # what was added 
